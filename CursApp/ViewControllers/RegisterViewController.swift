...
class RegisterViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        repPasswordTF.attributedPlaceholder = NSAttributedString.init(string:"请再次输入密码", attributes: [
            NSAttributedString.Key.foregroundColor:UIColor.gray])
    ...
    override func bindViewsTheme() {
        ...
        appTheme.rx
            ...
            .bind({ $0.textColor }, to: userNameTF.rx.textColor, passwordTF.rx.textColor, welcomeTX.rx.textColor, repPasswordTF.rx.textColor)
